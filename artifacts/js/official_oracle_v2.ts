...
import {
  ...
  getPositionDataLeo,
  getAttestedDataLeo
} from "./js2leo/official_oracle_v2";
import {
  getUniqueID,
  getPcrValues,
  getReportData,
  ...
  getPositionData,
  getAttestedData
} from "./leo2js/official_oracle_v2";
import {
  ContractConfig,
  zkGetMapping,
  LeoAddress,
...
import * as receipt from "./transitions/official_oracle_v2";

export class Official_oracle_v2Contract extends BaseContract {
  ...
  constructor(config: Partial < ContractConfig > = {
    ...
    super({
      ...config,
      appName: 'official_oracle_v2',
      fee: '0.01',
      contractPath: 'imports/official_oracle_v2',
      isImportedAleo: true
    });
  }
  async set_unique_id(r0: UniqueID): Promise < TransactionResponse < TransactionModel & receipt.Official_oracle_v2Set_unique_idTransition, [] >> {
  ...
  async set_pcr_values(r0: PcrValues): Promise < TransactionResponse < TransactionModel & receipt.Official_oracle_v2Set_pcr_valuesTransition, [] >> {
  ...
  async set_key(r0: LeoAddress, r1: boolean): Promise < TransactionResponse < TransactionModel & receipt.Official_oracle_v2Set_keyTransition, [] >> {
  ...
  async set_data_sgx(r0: ReportData, r1: Report, r2: string, r3: LeoAddress): Promise < TransactionResponse < TransactionModel & receipt.Official_oracle_v2Set_data_sgxTransition, [] >> {
  ...
  async set_data_nitro(r0: ReportData, r1: Report, r2: string, r3: LeoAddress, r4: PositionData, r5: PositionData, r6: PositionData, r7: PositionData): Promise < TransactionResponse < TransactionModel & receipt.Official_oracle_v2Set_data_nitroTransition, [] >> {
    const r0Leo = js2leo.json(getReportDataLeo(r0));
    const r1Leo = js2leo.json(getReportLeo(r1));
    const r2Leo = js2leo.signature(r2);
    const r3Leo = js2leo.address(r3);
